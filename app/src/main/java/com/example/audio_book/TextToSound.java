            ...
            public void onInit(int i) {
                if (i==TextToSpeech.SUCCESS){
                    ...
                    if (lang == TextToSpeech.LANG_MISSING_DATA || lang == TextToSpeech.LANG_NOT_SUPPORTED){
                        Toast.makeText(TextToSound.this, "Language is not supported", Toast.LENGTH_SHORT).show();
                    }
                    else{
                        Toast.makeText(TextToSound.this, "Language Supported", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
