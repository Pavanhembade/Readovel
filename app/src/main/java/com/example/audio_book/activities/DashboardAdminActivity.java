...
import com.example.audio_book.databinding.ActivityDashboardAdminBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.audioBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DashboardAdminActivity.this, BookPlayer.class));
            }
        });
        ...
        binding.ttsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DashboardAdminActivity.this, TextToSound.class));
            }
        });
    ...
    private void loadCategories() {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                //clear arraylist before adding data in it
