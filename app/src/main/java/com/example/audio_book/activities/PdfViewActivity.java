...
import com.example.audio_book.Constants;
import com.example.audio_book.databinding.ActivityPdfViewBinding;
...
public class PdfViewActivity extends AppCompatActivity {
    ...
    private void loadBookFromUrl(String pdfUrl) {
        Log.d(TAG, "loadBookFromUrl: Getting Pdf from Storage");
                        ...
                        binding.pdfView.fromBytes(bytes)
                                ...
                                .onPageChange(new OnPageChangeListener() {
                                    ...
                                    public void onPageChanged(int page, int pageCount) {
                                        ...
                                        binding.toolbarSubtitleTv.setText(currentPage + "/" + pageCount); //e.g. 3/256
