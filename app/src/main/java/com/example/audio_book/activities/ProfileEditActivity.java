...
import com.example.audio_book.databinding.ActivityProfileEditBinding;
...
public class ProfileEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.setCanceledOnTouchOutside(false); //don't dismiss while clicking outside dialog box
        ...
        reference.child(firebaseAuth.getUid())
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        //get all data of user here from snapshot
    ...
    private void pickImageCamera(){
        ...
        values.put(MediaStore.Images.Media.TITLE, "Sample Image Description");
    ...
    private void pickImageGallery(){
        //image to pick image from gallery
