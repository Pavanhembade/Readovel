...
import static com.example.audio_book.Constants.MAX_BYTES_PDF;
...
public class MyApplication extends Application {
    ...
    //created a static method to convert timestamp to proper date format, so we can use it anywhere in project, no need to rewrite again
